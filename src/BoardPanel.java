...
public class BoardPanel extends JPanel {
    ...
    private void drawTile(int x, int y, TileType type, Graphics g) {
        ...
        switch (type) {
             ...
             * A fruit1 is depicted as a small yellow circle that with a bit of 
             * padding on each side.
             * A fruit2 is depicted as a small blue circle that with a bit of 
             * padding on each side.
             *
             */
            case Fruit:
            ...
            case Badfruit:
                ...
                g.fillOval(x + 2, y + 2, TILE_SIZE - 4, TILE_SIZE - 4);
                g.setColor(Color.RED);
                int baseY1 = y + EYE_SMALL_INSET;
                g.drawLine(x + EYE_LARGE_INSET, baseY1, x
                        + TILE_SIZE - EYE_LARGE_INSET, baseY1
                        + (EYE_LENGTH *3));
                g.drawLine(x + TILE_SIZE - EYE_LARGE_INSET, baseY1, x
                        + EYE_LARGE_INSET, baseY1 + (EYE_LENGTH)*3);
                ...
                switch (game.getDirection()) {
                    case North: {
                        ...
                        g.drawLine(x + TILE_SIZE - EYE_LARGE_INSET, baseY, x
                                + TILE_SIZE - EYE_LARGE_INSET, baseY
                                + EYE_LENGTH);
                        break;
                    }
                    ...
                    case South: {
                        ...
                        g.drawLine(x + EYE_LARGE_INSET, baseY,
                                x + EYE_LARGE_INSET, baseY - EYE_LENGTH);
                        g.drawLine(x + TILE_SIZE - EYE_LARGE_INSET, baseY,
                                x + TILE_SIZE - EYE_LARGE_INSET, baseY
                                - EYE_LENGTH);
                        break;
                    }
